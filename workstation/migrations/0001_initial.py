# Generated by Django 3.2.5 on 2021-08-15 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to=utils.utils.FilePath, verbose_name='图片')),
                ('create_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort', models.CharField(blank=True, max_length=32, null=True, verbose_name='故障类型')),
                ('device_type', models.CharField(blank=True, max_length=32, null=True, verbose_name='设备')),
                ('workstation', models.CharField(blank=True, max_length=32, null=True, verbose_name='工位')),
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, null=True, verbose_name='更新时间')),
                ('maintenance_status', models.IntegerField(blank=True, choices=[(1, '完全修复'), (2, '临时修复')], null=True, verbose_name='故障状态')),
                ('order_status', models.IntegerField(blank=True, null=True, verbose_name='订单状态')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workstation.articles', verbose_name='经验总结'),
        ),
        migrations.AddField(
            model_name='maintenancerecords',
            name='inductor',
        ...
        migrations.AddField(
            model_name='articles',
            name='authors',
            field=models.ManyToManyField(blank=True, related_name='authors', to=settings.AUTH_USER_MODEL, verbose_name='作者'),
        ),
        migrations.AddField(
            model_name='articles',
            name='log',
            field=models.ManyToManyField(blank=True, to='workstation.MyLog', verbose_name='日志'),
        ),
        migrations.AddField(
            model_name='articles',
            name='main_author',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='main_author', to=settings.AUTH_USER_MODEL, verbose_name='第一作者'),
        ),
        migrations.AddField(
            model_name='articles',
            name='sort',
        ...
        migrations.AddField(
            model_name='articles',
            name='tag',
            field=models.ManyToManyField(blank=True, to='workstation.MyTag', verbose_name='标签'),
        ),
        migrations.AddIndex(
