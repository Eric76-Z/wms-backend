# Generated by Django 3.2.5 on 2021-07-28 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tcp', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='workstation.files', verbose_name='焊枪Tcp')),
        ...
        migrations.AddField(
            model_name='parts',
            name='part_file',
            field=models.ManyToManyField(blank=True, to='workstation.Files', verbose_name='备件图'),
        ),
        migrations.AddField(
            model_name='parts',
            name='sort',
        ...
        migrations.AddField(
            model_name='bladeapply',
            name='oldblade_img',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='oldblade_files', to='workstation.files', verbose_name='在用刀片图'),
        ),
        migrations.AddField(
            model_name='bladeapply',
            name='polestatus_img',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polestatus_files', to='workstation.files', verbose_name='电极帽状态'),
        ),
        migrations.AddField(
            model_name='bladeapply',
            name='receiver',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='repairorder_files', to='workstation.files', verbose_name='维修单图'),
        ),
        migrations.AddField(
            model_name='bladeapply',
            name='weldinggun',
